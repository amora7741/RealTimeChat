...
const LogoutPopover = ({userImage, userName, userEmail} : {userImage: string | null | undefined, userName: string | null | undefined, userEmail: string | null | undefined}) => {
          ...
          <div className='flex justify-between items-center w-full'>
            <div className="flex items-center gap-2">
              <div className='relative size-10 border rounded-full'>
                {userImage && (
                  <Image fill referrerPolicy="no-referrer" className='rounded-full' src={userImage || '' } alt='Your profile image' />
                )}
              </div>
